...
use Admin\Backend\Controllers\Admin\ApiCategoryController;
...
$router->mount('/api', function () use ($router) {
    $router->mount('/categories', function() use ($router) {
        $router->get('/', ApiCategoryController::class . '@index');
        $router->match('GET|POST','/them-moi-nhanh', ApiCategoryController::class . '@create');
    });
});
...
$router->mount('/admin', function () use ($router) {
    ...
    $router->mount('/danh-muc', function() use ($router) {
        ...
        // $router->post('/them-moi-nhanh',                                        CategoryController::class . '@quickCreate');   
